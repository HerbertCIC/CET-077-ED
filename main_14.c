...
int main(void){
    ...
    */
    ...
    /*
    PONTD listaDuplaEncOrd;
    /* 
        Geramos uma Lista duplamente encadeada utilizando
        os elementos da lista sequencial
    *//*
    listaDuplaEncOrd = conListSeqListDuplaEnc(&lista);

    if (lista.cap <= 10){
        printf("Lista encadeada\n");
        printListaEncAluno(listaDuplaEncOrd);
    }
